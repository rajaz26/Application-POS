  ...
  backgroundColor="white" />
        ...
        {userRole === 'GENERAL_MANAGER' && (
          ...
          (userRole === 'CASHIER' || userRole === 'WAREHOUSE_MANAGER' || userRole === 'PURCHASER') ? {justifyContent:'space-evenly' } : null,
                ...
                {userRole ==='GENERAL_MANAGER' ? (<TouchableOpacity style={styles.iconContainer} onPress={()=> navigation.navigate('Staff')}>  
                 <Ionic name="person" size={25} color={COLORS.primary} style={styles.homeIcon} />
                 <Text style={styles.iconText}>Staff List</Text>
               </TouchableOpacity>) :(<TouchableOpacity style={styles.iconContainer} onPress={()=> navigation.navigate('Profile')}>  
                    <Ionic name="person" size={25} color={COLORS.primary} style={styles.homeIcon} />
